# Opetushallinnon rekisteri- ja tietosuojaseloste

## Rekisterin nimi

Tietojenkäsittelytieteen kurssikirjanpidon hallinnointi.
...
Asiakasrekisteriin tallennettuja henkilötietoja käytetään käyttäjien henkilöllisyyden tarkistamiseen.
